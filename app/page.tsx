                ...
                <section className="py-20">
                    <div className="container mx-auto px-4">
                        <p className="text-center text-gray-600 text-xl max-w-3xl mx-auto mb-16">
                            Next Gen Vet este o clinică veterinară modernă, deschisă în 2024. Oferim o gamă completă de
                            servicii
                            medicale pentru animalele de companie, combinând expertiza profesională cu tehnologia de
                            ultimă generație
